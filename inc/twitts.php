    ...
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>It's responsive workshopping time. In Armenia, Yerevan. <a href="">http://uxyerevan.am #uxyerevan</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>Don't miss your chance to participate in UX and front-end workshop with Vitaly Friedman! <a href="">@uxevn #uxevn #uxyerevan http://buff.ly/1Jf74wS</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>Just got an awesome presentation about CSS flexbox from Vitaly Friedman. <a href="">#uxevn #uxyerevan</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>Save your place for <a href="">@smashingmag</a> co-founder <a href="">@vitalyf's #UX</a> workshop in <a href="">#Yerevan</a> here: <a href="">http://uxyerevan.am @uxevn</a> </span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>Great ux workshop by Vitaly Friedman. <a href="">@smashingmag #uxyerevan #uxevn</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span> Thanks Vitaly for great sunday! :) <a href="">#uxyerevan</a> @Yerevan Plaza </span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>What do you do on a rainy Saturday? Attend UX Yerevan 18 <a href="">#uxevn #uxyerevan18 #uxdesign</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>Really a smashing workshop  <a href="">#uxevn #uxyerevan @vitalyf</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>All about <a href="">#UX</a> in one day workshop by co-founder of  <a href="">@smashingmag</a> Vitaliy Friedman  <a href="">#uxyerevan @uxevn</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>Ok, let's go ahead to Web Forms UX with Vitaly Friedman.<a href=""> #uxyerevan #uxevn</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>personality and humanity. precisely the things that make <a href="">@smashingmag</a> one of my favorite speakers ever. <a href="">#uxevn</a></span>
            </div>
        </div>
    </div>
    <div>
        <div class="twits-carousel__item" onclick="window.open('/', '_blank')">
            ...
            <div class="twits-carousel__info">
                <span>It was nice to be a part of this event. Thx to all organizers <a href="">@uxevn #uxyerevan #uxyerevan2018 #uxevn</a></span>
            </div>
        </div>
    </div>
</div>
