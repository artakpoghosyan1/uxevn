                       ...
                       <div class="speaker-item-wrapper__left speaker-head-info">
                           <div class="speaker-box speaker-box--secondary">
                               ...
                               <div class="speaker-box__info">
                                   <div>
                                       <p class="speaker-box__name">Rafayel Mkrtchyan</p>
                                       <p class="speaker-box__position">Design2Science Host</p>
                                   </div>
                                   <ul class="info-list">
                                       <li><a href="https://www.linkedin.com/in/rafayelmkrtchyan/  " target="_blank">Linkedin</a></li>
