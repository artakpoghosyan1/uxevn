                       ...
                       <div class="speaker-item-wrapper__left speaker-head-info">
                           <div class="speaker-box speaker-box--secondary">
                               ...
                               <div class="speaker-box__info">
                                   <div>
                                       <p class="speaker-box__name">JEFF GOTHELF</p>
                                       <p class="speaker-box__position">Author of Forever Employable Co-author of Lean UX and Sense & Respond</p>
                                   </div>
                                   <ul class="info-list">
                                       <li><a href="https://www.linkedin.com/in/gothelf/" target="_blank">Linkedin</a></li>
                                       <li><a href="" target="_blank">Twitter</a></li>
                                   </ul>
                               </div>
                           </div>
                       </div>
                       <a href="/#buyTicketSection" class="def-button def-button--tertiary scroll-page js-hover-reaction">
