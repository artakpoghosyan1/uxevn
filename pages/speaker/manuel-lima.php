                       ...
                       <div class="speaker-item-wrapper__left speaker-head-info">
                           <div class="speaker-box speaker-box--secondary">
                               ...
                               <div class="speaker-box__info">
                                   <div>
                                       <p class="speaker-box__name">Manuel Lima</p>
                                       <p class="speaker-box__position">Head of Google Cloud Datavis</p>
                                   </div>
                                   <ul class="info-list">
                                       <li><a href="https://www.linkedin.com/in/mslima/" target="_blank">Linkedin</a></li>
